...
//
//        // 包下面的类
//        Set<Class<?>> clazzs = getClasses("cn.wuzuqing.greendao.bean");
//        if (clazzs == null) {
//            return;
//        }
//
...
//    }
    ...
    public static List<Class<?>> getClassName(Context context, String packageName) {
        ...
        try {
            ...
            while (enumeration.hasMoreElements()) {//遍历
                ...
                if (className.contains(packageName)) {//在当前所有可执行的类里面查找包含有该包名的所有类
                    Class<?> entryClass = df.loadClass(className, classLoader);
                    Entity entity = entryClass.getAnnotation(Entity.class);
                    if (entity != null) {
